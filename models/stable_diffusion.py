        ...
        for t in op:
            ...
            if do_classifier_free_guidance:
                ...
                if swap_guidance_scale > 1.0 and is_cross_image_step:
                    ...
                    noise_pred = noise_pred_no_swap + 5 * (noise_pred_swap - noise_pred_no_swap)
                    noise_pred = rescale_noise_cfg(noise_pred, noise_pred_swap, guidance_rescale=guidance_scale)
                    # replace
