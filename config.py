...
class RunConfig:
    ...
    app_image_path: Path = Path("./inputs/style/1.jpg")
    # Struct image path
    struct_image_path: Path = Path("./inputs/content/brad_pitt.jpg")
    # Domain name (e.g., buildings, animals)
    domain_name: Optional[str] = "building"
    # Output path
    ...
    cross_attn_32_range: Range = Range(start=0, end=90)
