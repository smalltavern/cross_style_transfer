...
from util.adain import adain, masked_adain # type: ignore
from util.model_utils import get_stable_diffusion_model
import torch
from util import attention_utils
from constants import OUT_INDEX, STYLE_INDEX, STRUCT_INDEX
from torch.nn import functional as F
from util.segmentation import Segmentor
...
class AppearanceTransferModel:
    ...
    def set_latents(self, latents_style, latents_content):
        self.latents_style = latents_style
        self.latents_content = latents_content

    def set_noise(self, zs_style, zs_content):
    ...
    def register_attention_control(self):
        ...
        class AttentionProcessor:
            ...
            def __call__(self,
                ...
                if perform_swap and not is_cross and ("up" or "down" or "mid" in self.place_in_unet) and model_self.enable_edit :
                ...
                hidden_states, attn_weight = attention_utils.compute_scaled_dot_product_attention(
                    query, key, value,
                    edit_map=perform_swap and model_self.enable_edit,
                    is_cross=is_cross,
